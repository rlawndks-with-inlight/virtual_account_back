...
if (process.env.NODE_ENV == 'development') {
  ...
  const options = { // letsencrypt로 받은 인증서 경로를 입력해 줍니다.
    ca: fs.readFileSync("/etc/letsencrypt/live/purplevery31.cafe24.com/fullchain.pem"),
    key: fs.readFileSync("/etc/letsencrypt/live/purplevery31.cafe24.com/privkey.pem"),
    cert: fs.readFileSync("/etc/letsencrypt/live/purplevery31.cafe24.com/cert.pem")
  };
